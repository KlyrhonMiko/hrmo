...
type TaskColor = "amber" | "blue" | "green";

const pendingTasks: Array<{ label: string; count: number; icon: React.ElementType; color: TaskColor }> = [
...
const colorMap: Record<TaskColor, { bg: string; text: string }> = {
    amber: { bg: "bg-amber-50", text: "text-amber-700" },
    blue:  { bg: "bg-blue-50",  text: "text-blue-700"  },
    green: { bg: "bg-green-50", text: "text-green-700" },
};

type ShortcutColor = "green" | "teal" | "emerald" | "amber";

const shortcuts: Array<{ label: string; description: string; href: string; icon: React.ElementType; color: ShortcutColor }> = [
    { label: "PDS Data Entry",   description: "Add new employee record",   href: "/hr-record-asst/onboard",           icon: UserPlus,    color: "green"   },
    { label: "Scan Certificates", description: "Upload MOV documents",      href: "/hr-record-asst/certificates",      icon: ScanLine,    color: "teal"    },
    { label: "Employee 201",     description: "Browse employee files",      href: "/hr-record-asst/directory",         icon: FolderOpen,  color: "emerald" },
    { label: "Training Records", description: "Track training data",        href: "/hr-record-asst/training/tracking", icon: GraduationCap, color: "amber" },
];

const shortcutColorMap: Record<ShortcutColor, { bg: string; text: string }> = {
    green:   { bg: "bg-green-50",   text: "text-green-700"   },
